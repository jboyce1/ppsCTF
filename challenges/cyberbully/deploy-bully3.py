...
# Configuration
TAR_FILE = "Bully3.tar.gz"  # Assumed to be in the same directory as the script
...
def distribute_files():
    base_extracted_path = os.path.join(EXTRACT_PATH, "Bully3")
    for user in USER_CREDENTIALS.keys():
...
def main():
    ...
    setup_ssh()
    distribute_files()
    print("[✅] Bully3 setup complete! Ready for CTF deployment.")
